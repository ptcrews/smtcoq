...
import os
import shutil
pathsmt = input('Enter full path of SMT file: ')
pathpf = input('Enter full path of proof file: ')
name = input('Enter file name without extension: ')
smtname = "/home/arjun/Desktop/smtcoq/arjunvish-smtcoq-veritAst/smtcoq/examples/aletheTests/testbenchmarks/" + name + ".smt2"
pfname = "/home/arjun/Desktop/smtcoq/arjunvish-smtcoq-veritAst/smtcoq/examples/aletheTests/testbenchmarks/" + name + ".pf"
shutil.copy(pathsmt, smtname)
shutil.copy(pathpf, pfname)
...
f.write("  Verit_Checker \"" + smtname + "\" \"" + pfname + "\".\n")
...
f.write("  \"/home/arjun/Desktop/smtcoq/arjunvish-smtcoq-veritAst/smtcoq/examples/aletheTests/testbenchmarks/" + name + ".smt2\"\n")
f.write("  \"/home/arjun/Desktop/smtcoq/arjunvish-smtcoq-veritAst/smtcoq/examples/aletheTests/testbenchmarks/" + name + ".pf\".\n")
