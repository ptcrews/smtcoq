...
Section Test1Debug.
  ...
  Print s5_1.
  (* s5_1 = ({|0 -> [4], 1 -> [0; 6; 8], 2 -> [1; 2; 6], 3 -> [1; 3; 10]|} *)
  ...
  Print s6_1.
  (* s6_1 = ({|0 -> [4], 1 -> [0; 6; 8], 2 -> [1; 6; 10], 3 -> [1; 3; 10]|} *)
  ...
  Print s7_1.
  (* s7_1 = ({|0 -> [4], 1 -> [0; 6; 8], 2 -> [6; 8; 10], 3 -> [1; 3; 10]|} *)
