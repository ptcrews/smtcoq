...
(* [Require Import SMTCoq.SMTCoq.] loads the SMTCoq library.
   ...
   *)
   ...
   Section Checker_SmtEx6.
     Parse_certif_verit t_i6 t_func6 t_atom6 t_form6 root6 used_roots6 trace6
     "/home/arjun/Desktop/smtcoq/arjunvish-smtcoq-veritAst/smtcoq/examples/aletheTests/sanitychecktests/test6.smt2" 
     "/home/arjun/Desktop/smtcoq/arjunvish-smtcoq-veritAst/smtcoq/examples/aletheTests/sanitychecktests/test6.pf".
     (*
     ...
     *)
     ...
     Definition nclauses6 := Eval vm_compute in (match trace6 with Certif a _ _ => a end). (* Size of the state *)
     Print nclauses6. (* 4 *)
     Definition c6 := Eval vm_compute in (match trace6 with Certif _ a _ => a end). (* Certificate of type (list step) * step*)
     Print c6.
