...
Section Test2Debug.
  ...
  "/home/arjun/Desktop/smtcoq-veritAst//smtcoq/examples/test2.smt2"
  "/home/arjun/Desktop/smtcoq-veritAst//smtcoq/examples/test2.vtlog".
  ...
  Print s41_2.
  (* s41_2 = ({|  |} *)
  Eval vm_compute in List.nth 41 (fst c2) _.
  (* 42 *)
  Definition s42_2 := Eval vm_compute in (step_checker s41_2 (List.nth 41 (fst c2) (CTrue t_func2 t_atom2 t_form2 0))).
  Print s42_2.
  (* s42_2 = ({|  |} *)
  Eval vm_compute in List.nth 42 (fst c2) _.
  (* 43 *)
  Definition s43_2 := Eval vm_compute in (step_checker s42_2 (List.nth 42 (fst c2) (CTrue t_func2 t_atom2 t_form2 0))).
  Print s43_2.
  (* s43_2 = ({|  |} *)
  Eval vm_compute in List.nth 43 (fst c2) _.
  (* 44 *)
  Definition s44_2 := Eval vm_compute in (step_checker s43_2 (List.nth 43 (fst c2) (CTrue t_func2 t_atom2 t_form2 0))).
  Print s44_2.
  (* s44_2 = ({|  |} *)
End Test2Debug.
