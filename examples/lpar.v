...
2. time abduce 4. (* with cvc5-lpar23 where grammar doesn't have ITE *)
...
3. time abduce 3. (* with cvc5-noSygusIte where grammar doesn't have ITE 
and OR *)
