...
Module Z_as_Int <: Int.
  ...
  Proof. Show. Fail (abduce 3 2). Admitted.
  Lemma i2z_0 : i2z _0 = 0.  Proof. Show. Fail (abduce 3 2). Admitted.
  Lemma i2z_1 : i2z _1 = 1.  Proof. Show. Fail (abduce 3 2). Admitted.
  Lemma i2z_2 : i2z _2 = 2.  Proof. Show. Fail (abduce 3 2). Admitted.
  Lemma i2z_3 : i2z _3 = 3.  Proof. Show. Fail (abduce 3 2). Admitted.
