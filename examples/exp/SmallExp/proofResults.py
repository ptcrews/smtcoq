...
for i in f1lines:
  #Goal count
  if re.fullmatch(r'1 goal\n', i):
    numgoals += 1
  #Identify cvc5 configuration
  if re.fullmatch(r'\"option 1\"%string\n', i):
    optCurr = 1
    optCurrCnt[0] += 1
  if re.fullmatch(r'\"option 2\"%string\n', i):
    optCurr = 2
    optCurrCnt[1] += 1
  if re.fullmatch(r'\"option 3\"%string\n', i):
    optCurr = 3
    optCurrCnt[2] += 1
  if re.fullmatch(r'\"option 4\"%string\n', i):
    optCurr = 4
    optCurrCnt[3] += 1
  if re.fullmatch(r'\"option 5\"%string\n', i):
    optCurr = 5
    optCurrCnt[4] += 1
  if re.fullmatch(r'\"option 6\"%string\n', i):
    optCurr = 6
    optCurrCnt[5] += 1
  if re.fullmatch(r'\"option 7\"%string\n', i):
    optCurr = 7
    optCurrCnt[6] += 1
  if re.fullmatch(r'\"option 8\"%string\n', i):
    optCurr = 8
    optCurrCnt[7] += 1
  if re.fullmatch(r'\"option 9\"%string\n', i):
    optCurr = 9
    optCurrCnt[8] += 1
  if re.fullmatch(r'\"option 10\"%string\n', i):
    optCurr = 10
    optCurrCnt[9] += 1
  if re.fullmatch(r'\"option 11\"%string\n', i):
    optCurr = 11
    optCurrCnt[10] += 1
  if re.fullmatch(r'\"option 12\"%string\n', i):
    optCurr = 12
    optCurrCnt[11] += 1
  #Identify case
...
fopname = input('Enter output file name: ')
f2 = open(fopname, "w")
f2.write("Option, # get-abd successes, # smt successes, # non-bool equality failures, # abd reconstructr failures, # atom unexp type failures, # non-linear failures\n")
f2.write("1," + str(op1[0]) + "," + str(op1[1]) + "," + str(op1[2]) + "," + str(op1[3]) + "," + str(op1[4]) + "," + str(op1[5]) + "\n")
f2.write("2," + str(op2[0]) + "," + str(op2[1]) + "," + str(op2[2]) + "," + str(op2[3]) + "," + str(op2[4]) + "," + str(op2[5]) + "\n")
f2.write("3," + str(op3[0]) + "," + str(op3[1]) + "," + str(op3[2]) + "," + str(op3[3]) + "," + str(op3[4]) + "," + str(op3[5]) + "\n")
f2.write("4," + str(op4[0]) + "," + str(op4[1]) + "," + str(op4[2]) + "," + str(op4[3]) + "," + str(op4[4]) + "," + str(op4[5]) + "\n")
f2.write("5," + str(op5[0]) + "," + str(op5[1]) + "," + str(op5[2]) + "," + str(op5[3]) + "," + str(op5[4]) + "," + str(op5[5]) + "\n")
f2.write("6," + str(op6[0]) + "," + str(op6[1]) + "," + str(op6[2]) + "," + str(op6[3]) + "," + str(op6[4]) + "," + str(op6[5]) + "\n")
f2.write("7," + str(op7[0]) + "," + str(op7[1]) + "," + str(op7[2]) + "," + str(op7[3]) + "," + str(op7[4]) + "," + str(op7[5]) + "\n")
f2.write("8," + str(op8[0]) + "," + str(op8[1]) + "," + str(op8[2]) + "," + str(op8[3]) + "," + str(op8[4]) + "," + str(op8[5]) + "\n")
f2.write("9," + str(op9[0]) + "," + str(op9[1]) + "," + str(op9[2]) + "," + str(op9[3]) + "," + str(op9[4]) + "," + str(op9[5]) + "\n")
f2.write("10," + str(op10[0]) + "," + str(op10[1]) + "," + str(op10[2]) + "," + str(op10[3]) + "," + str(op10[4]) + "," + str(op10[5]) + "\n")
f2.write("11," + str(op11[0]) + "," + str(op11[1]) + "," + str(op11[2]) + "," + str(op11[3]) + "," + str(op11[4]) + "," + str(op11[5]) + "\n")
f2.write("12," + str(op12[0]) + "," + str(op12[1]) + "," + str(op12[2]) + "," + str(op12[3]) + "," + str(op12[4]) + "," + str(op12[5]) + "\n")
print("Sanity checks:")
