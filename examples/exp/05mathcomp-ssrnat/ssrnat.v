...
Lemma succnK : cancel succn predn. Proof. Show. Fail (abduce 3). Admitted.
Lemma succn_inj : injective succn. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma eqnE : eqn = eq_op. Proof. Show. Fail (abduce 3). Admitted.

Lemma eqSS m n : (m.+1 == n.+1) = (m == n). Proof. Show. Fail (abduce 3). Admitted.
...
Lemma addnE : addn = addn_rec. Proof. Show. Fail (abduce 3). Admitted.

Lemma plusE : plus = addn. Proof. Show. Fail (abduce 3). Admitted.

Lemma add0n : left_id 0 addn.            Proof. Show. Fail (abduce 3). Admitted.
Lemma addSn m n : m.+1 + n = (m + n).+1. Proof. Show. Fail (abduce 3). Admitted.
Lemma add1n n : 1 + n = n.+1.            Proof. Show. Fail (abduce 3). Admitted.

Lemma addn0 : right_id 0 addn. Proof. Show. Fail (abduce 3). Admitted.

Lemma addnS m n : m + n.+1 = (m + n).+1. Proof. Show. Fail (abduce 3). Admitted.

Lemma addSnnS m n : m.+1 + n = m + n.+1. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma addn1 n : n + 1 = n.+1. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma addn2 m : m + 2 = m.+2. Proof. Show. Fail (abduce 3). Admitted.
Lemma add2n m : 2 + m = m.+2. Proof. Show. Fail (abduce 3). Admitted.
Lemma addn3 m : m + 3 = m.+3. Proof. Show. Fail (abduce 3). Admitted.
Lemma add3n m : 3 + m = m.+3. Proof. Show. Fail (abduce 3). Admitted.
Lemma addn4 m : m + 4 = m.+4. Proof. Show. Fail (abduce 3). Admitted.
Lemma add4n m : 4 + m = m.+4. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma subnE : subn = subn_rec. Proof. Show. Fail (abduce 3). Admitted.
Lemma minusE : minus = subn.   Proof. Show. Fail (abduce 3). Admitted.

Lemma sub0n : left_zero 0 subn.    Proof. Show. Fail (abduce 3). Admitted.
Lemma subn0 : right_id 0 subn.   Proof. Show. Fail (abduce 3). Admitted.
Lemma subnn : self_inverse 0 subn. Proof. Show. Fail (abduce 3). Admitted.

Lemma subSS n m : m.+1 - n.+1 = m - n. Proof. Show. Fail (abduce 3). Admitted.
Lemma subn1 n : n - 1 = n.-1.          Proof. Show. Fail (abduce 3). Admitted.
Lemma subn2 n : (n - 2)%N = n.-2.      Proof. Show. Fail (abduce 3). Admitted.
...
Lemma ltnS m n : (m < n.+1) = (m <= n). Proof. Show. Fail (abduce 3). Admitted.
Lemma leq0n n : 0 <= n.                 Proof. Show. Fail (abduce 3). Admitted.
Lemma ltn0Sn n : 0 < n.+1.              Proof. Show. Fail (abduce 3). Admitted.
Lemma ltn0 n : n < 0 = false.           Proof. Show. Fail (abduce 3). Admitted.
Lemma leqnn n : n <= n.                 Proof. Show. Fail (abduce 3). Admitted.
#[global] Hint Resolve leqnn : core.
Lemma ltnSn n : n < n.+1.               Proof. Show. Fail (abduce 3). Admitted.
Lemma eq_leq m n : m = n -> m <= n.     Proof. Show. Fail (abduce 3). Admitted.
Lemma leqnSn n : n <= n.+1.             Proof. Show. Fail (abduce 3). Admitted.
#[global] Hint Resolve leqnSn : core.
Lemma leq_pred n : n.-1 <= n.           Proof. Show. Fail (abduce 3). Admitted.
Lemma leqSpred n : n <= n.-1.+1.        Proof. Show. Fail (abduce 3). Admitted.
...
Lemma leqVgt m n : (m <= n) || (n < m). Proof. Show. Fail (abduce 3). Admitted.
...
Lemma leqn0 n : (n <= 0) = (n == 0).           Proof. Show. Fail (abduce 3). Admitted.
Lemma lt0n n : (0 < n) = (n != 0).             Proof. Show. Fail (abduce 3). Admitted.
Lemma lt0n_neq0 n : 0 < n -> n != 0.           Proof. Show. Fail (abduce 3). Admitted.
Lemma eqn0Ngt n : (n == 0) = ~~ (n > 0).       Proof. Show. Fail (abduce 3). Admitted.
Lemma neq0_lt0n n : (n == 0) = false -> 0 < n. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma ubnP m : {n | m < n}.             Proof. Show. Fail (abduce 3). Admitted.
Lemma ltnSE m n : m < n.+1 -> m <= n.   Proof. Show. Fail (abduce 3). Admitted.
...
Lemma ubnPleq m : ubn_leq_spec m m.    Proof. Show. Fail (abduce 3). Admitted.
Lemma ubnPgeq m : ubn_geq_spec m m.    Proof. Show. Fail (abduce 3). Admitted.
Lemma ubnPeq m : ubn_eq_spec m m.      Proof. Show. Fail (abduce 3). Admitted.
...
Lemma leq_addl m n : n <= m + n. Proof. Show. Fail (abduce 3). Admitted.

Lemma leq_addr m n : n <= n + m. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma subnSK m n : m < n -> (n - m.+1).+1 = n - m. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma max0n : left_id 0 maxn.  Proof. Show. Fail (abduce 3). Admitted.
Lemma maxn0 : right_id 0 maxn. Proof. Show. Fail (abduce 3). Admitted.
...
Proof. Show. Fail (abduce 3). Admitted.
Lemma leq_maxl m n : m <= maxn m n. Proof. Show. Fail (abduce 3). Admitted.
Lemma leq_maxr m n : n <= maxn m n. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma min0n : left_zero 0 minn. Proof. Show. Fail (abduce 3). Admitted.
Lemma minn0 : right_zero 0 minn. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma geq_minl m n : minn m n <= m. Proof. Show. Fail (abduce 3). Admitted.
Lemma geq_minr m n : minn m n <= n. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma iterS n f x : iter n.+1 f x = f (iter n f x). Proof. Show. Fail (abduce 3). Admitted.
...
Lemma multE : mult = muln.     Proof. Show. Fail (abduce 3). Admitted.
Lemma mulnE : muln = muln_rec. Proof. Show. Fail (abduce 3). Admitted.

Lemma mul0n : left_zero 0 muln.          Proof. Show. Fail (abduce 3). Admitted.
Lemma muln0 : right_zero 0 muln.         Proof. Show. Fail (abduce 3). Admitted.
Lemma mul1n : left_id 1 muln.            Proof. Show. Fail (abduce 3). Admitted.
Lemma mulSn m n : m.+1 * n = n + m * n.  Proof. Show. Fail (abduce 3). Admitted.
Lemma mulSnr m n : m.+1 * n = m * n + n. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma expnE : expn = expn_rec. Proof. Show. Fail (abduce 3). Admitted.

Lemma expn0 m : m ^ 0 = 1. Proof. Show. Fail (abduce 3). Admitted.
Lemma expn1 m : m ^ 1 = m. Proof. Show. Fail (abduce 3). Admitted.
Lemma expnS m n : m ^ n.+1 = m * m ^ n. Proof. Show. Fail (abduce 3). Admitted.
Lemma expnSr m n : m ^ n.+1 = m ^ n * m. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma exp0n n : 0 < n -> 0 ^ n = 0. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma factE : factorial = fact_rec. Proof. Show. Fail (abduce 3). Admitted.

Lemma fact0 : 0`! = 1. Proof. Show. Fail (abduce 3). Admitted.

Lemma factS n : (n.+1)`!  = n.+1 * n`!. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma leq_b1 (b : bool) : b <= 1. Proof. Show. Fail (abduce 3). Admitted.

Lemma addn_negb (b : bool) : ~~ b + b = 1. Proof. Show. Fail (abduce 3). Admitted.

Lemma eqb0 (b : bool) : (b == 0 :> nat) = ~~ b. Proof. Show. Fail (abduce 3). Admitted.

Lemma eqb1 (b : bool) : (b == 1 :> nat) = b. Proof. Show. Fail (abduce 3). Admitted.

Lemma lt0b (b : bool) : (b > 0) = b. Proof. Show. Fail (abduce 3). Admitted.

Lemma sub1b (b : bool) : 1 - b = ~~ b. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma oddS n : odd n.+1 = ~~ odd n. Proof. Show. Fail (abduce 3). Admitted.

Lemma oddb (b : bool) : odd b = b. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma doubleE : double = double_rec. Proof. Show. Fail (abduce 3). Admitted.

Lemma double0 : 0.*2 = 0. Proof. Show. Fail (abduce 3). Admitted.

Lemma doubleS n : n.+1.*2 = n.*2.+2. Proof. Show. Fail (abduce 3). Admitted.

Lemma double_pred n : n.-1.*2 = n.*2.-2. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma odd_gt0 n : odd n -> n > 0. Proof. Show. Fail (abduce 3). Admitted.
