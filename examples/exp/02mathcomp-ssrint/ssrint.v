...
Lemma eqz_nat (m n : nat) : (m%:Z == n%:Z) = (m == n). Proof. Show. Fail (abduce 3). Admitted.
...
Lemma PoszD : {morph Posz : m n / (m + n)%N >-> m + n}. Proof. Show. Fail (abduce 3). Admitted.

Local Coercion Posz : nat >-> int.

Lemma NegzE (n : nat) : Negz n = - n.+1. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma intP x : int_spec x x. Proof. Show. Fail (abduce 3). Admitted.

Lemma addzC : commutative addz.
Proof. Show. Fail (abduce 3). Admitted.

Lemma add0z : left_id 0 addz. Proof. Show. Fail (abduce 3). Admitted.

Lemma oppzK : involutive oppz. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma addNz : left_inverse (0:int) oppz addz. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma PoszD : {morph Posz : n m / (n + m)%N >-> n + m}. Proof. Show. Fail (abduce 3). Admitted.

Lemma NegzE (n : nat) : Negz n = -(n.+1)%:Z. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma nonzero1z : 1%Z != 0. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma PoszM : {morph Posz : n m / (n * m)%N >-> n * m}. Proof. Show. Fail (abduce 3). Admitted.

Lemma intS (n : nat) : n.+1%:Z = 1 + n%:Z. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma lez_nat m n : (m <= n :> int) = (m <= n)%N. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma leNz_nat m n : (- m%:Z <= n). Proof. Show. Fail (abduce 3). Admitted.
...
Lemma le0z_nat n : 0 <= n :> int. Proof. Show. Fail (abduce 3). Admitted.

Lemma lez0_nat n : n <= 0 :> int = (n == 0%N :> nat). Proof. Show. Fail (abduce 3). Admitted.

Definition ltezN_nat := (lezN_nat, ltzN_nat).
Definition ltez_natE := (ltez_nat, lteNz_nat, ltezN_nat, le0z_nat, lez0_nat).

Lemma gtz0_ge1 x : (0 < x) = (1 <= x). Proof. Show. Fail (abduce 3). Admitted.
...
Fact mulr1z (x : M) : x *~ 1 = x. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma scalezrE n x : n *: (x : M^z) = x *~ n. Proof. Show. Fail (abduce 3). Admitted.

Lemma mulrzA x m n :  x *~ (m * n) = x *~ m *~ n.
Proof. Show. Fail (abduce 3). Admitted.

Lemma mulr0z x : x *~ 0 = 0. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma mulrN1z x : x *~ (- 1) = - x. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma mulr2z n : n *~ 2 = n + n. Proof. Show. Fail (abduce 3). Admitted.

End RintMod.

Lemma mulrzz m n : m *~ n = m * n. Proof. Show. Fail (abduce 3). Admitted.

Lemma mulz2 n : n * 2%:Z = n + n. Proof. Show. Fail (abduce 3). Admitted.

Lemma mul2z n : 2%:Z * n = n + n. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma rmorphMz : forall n, {morph f : x / x *~ n}. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma linearMn : forall n, {morph f : x / x *~ n}. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma exprnP x (n : nat) : x ^+ n = x ^ n. Proof. Show. Fail (abduce 3). Admitted.

Lemma exprnN x (n : nat) : x ^- n = x ^ -n%:Z.
Proof. Show. Fail (abduce 3). Admitted.

Lemma expr0z x : x ^ 0 = 1. Proof. Show. Fail (abduce 3). Admitted.

Lemma expr1z x : x ^ 1 = x. Proof. Show. Fail (abduce 3). Admitted.

Lemma exprN1 x : x ^ (-1) = x^-1. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma exprSz x (n : nat) : x ^ n.+1 = x * x ^ n. Proof. Show. Fail (abduce 3). Admitted.

Lemma exprSzr x (n : nat) : x ^ n.+1 = x ^ n * x. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma sgrEz x : sgr x = (sgz x)%:~R. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma sgz0 : sgz (0 : R) = 0. Proof. Show. Fail (abduce 3). Admitted.
Lemma sgz1 : sgz (1 : R) = 1. Proof. Show. Fail (abduce 3). Admitted.
Lemma sgzN1 : sgz (-1 : R) = -1. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma sgrz (n : int) : sgr n = sgz n. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma absz_nat (n : nat) : `|n| = n. Proof. Show. Fail (abduce 3). Admitted.

Lemma abszE (m : int) : `|m| = `|m|%R :> int. Proof. Show. Fail (abduce 3). Admitted.

Lemma absz0 : `|0%R| = 0. Proof. Show. Fail (abduce 3). Admitted.

Lemma abszN m : `|- m| = `|m|. Proof. Show. Fail (abduce 3). Admitted.

Lemma absz_eq0 m : (`|m| == 0) = (m == 0%R). Proof. Show. Fail (abduce 3). Admitted.

Lemma absz_gt0 m : (`|m| > 0) = (m != 0%R). Proof. Show. Fail (abduce 3). Admitted.

Lemma absz1 : `|1%R| = 1. Proof. Show. Fail (abduce 3). Admitted.

Lemma abszN1 : `|-1%R| = 1. Proof. Show. Fail (abduce 3). Admitted.

Lemma absz_id m : `|(`|m|)| = `|m|. Proof. Show. Fail (abduce 3). Admitted.
...
Lemma absz_sg m : `|sgr m| = (m != 0%R). Proof. Show. Fail (abduce 3). Admitted.
...
(* Most of this Proof. Show. Fail (abduce 3). Admitted.
...
Lemma Znat_def n : (n \is a Znat) = (0 <= n). Proof. Show. Fail (abduce 3). Admitted.
