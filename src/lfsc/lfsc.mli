...
val tactic_abduct : int -> int -> EConstr.t -> CoqInterface.constr_expr list -> CoqInterface.tactic
val tactic_abduct2 : int -> int -> int -> EConstr.t -> CoqInterface.constr_expr list -> CoqInterface.tactic