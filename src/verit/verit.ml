...
let call_verit timeout _ _ _ _ rt ro ra_quant rf_quant first lsmt =
...
let tactic_gen vm_cast timeout lcpl lcepl =
  ...
  let ra_quant = VeritSyntax.ra_quant in
  let rf_quant = VeritSyntax.rf_quant in
  SmtCommands.tactic 0 0 0 (call_verit timeout) verit_logic rt ro ra rf ra_quant rf_quant vm_cast lcpl lcepl
